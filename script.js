...
const osisData = {
    ...
    keagamaan: {
        ...
        members: ["Ketua: Nur Anisa", "Anggota: Ahmad ilmi", "Anggota: M.Rifa'i", "Anggota: Norbayati", "Anggota: Siti Khadijah", "Anggota: Fitri", "Anggota: Nurul aida", "Anggota: Nafis"]
    },
    pembinaan_karakter: {
    ...
    olahraga_seni: {
        ...
        members: ["Ketua: Fahrurazi Akbar", "Anggota: Dayat", "Anggota: Erlina", "Anggota: Assyifa", "Anggota: Anisa fitri", "Anggota: Nor Aisya", "Anggota: Munawarah MP.B"]
    },
    humas_sosial: {
        title: "Departemen Humas Sosial Masyarakat dan Komunikasi",
        members: ["Ketua: Muhammad wafa", "Anggota: Rudi", "Anggota: M.Arbayu Saputra", "Anggota: Nazwa ameliya", "Anggota: Norhidayati", "Anggota: Raida", "Anggota: Nurin Shahifah", "Anggota: Saidah"]
    },
...
const dashboardData = {
    ...
    // Hanya Pengurus Inti dan Ketua Departemen (Tanpa Anggota/Staf dan tanpa Pembina/Pahriadi)
    inti_dan_ketua: {
...
const prokerData = {
    ...
    keagamaan: {
        ...
        content: `
            ...
            <p>Tugas-tugas utama meliputi: membuat jadwal literasi dan piket musholla (Siti Khadijah), membuat jadwal habsyi burdah (Nurul), membuat data tidak membaca literasi/tadarus per kelas (M.Rifa'i dan M.Amin Jazuli), mengirim data tidak membaca Al-Qur'an dan data haid ke wali kelas (Laila), dan membuat data habsy burdah SMKS Shabit Hamsan.</p>
            <h4>Arahan Khusus:</h4>
            <ul>
                ...
                <li>M.Rifa'i & M.Amin Jazuli: Mengolah data di Excel/Spreadsheet dan mencatat setiap hari.</li>
